...
while True:
    ...
    display.fill(0)
    display.text(f'{round(hum,2)} %', 0, 0, 1)
    display.text(f'{round(temp,2)}', 0, 10, 1)
    display.rect(40, 10, 3,3,1)
    display.text('C', 44,10,1)
    display.text(f'{eco2.value}ppm', 0, 20, 1)
    display.show()
